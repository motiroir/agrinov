...
namespace AgriNov.Models
{
    public class ServiceActivity : IServiceActivity
    {
        ...
        public void InitializeTable()
        {
            ...
            Activity a7 = new Activity() { Name = "Fabrication de fromage fermier", OrganizerId = 4, Location = "Vallet", Duration = 8, MaxParticipants = 6, MaxInvitesPerPerson = 1, Datetime = new DateTime(2024, 12, 15, 15, 0, 0), Description = "Apprenez à fabriquer du fromage à partir de lait cru local. Repartez avec vos créations à savourer chez vous." };
            ...
            Activity a11 = new Activity() { Name = "Cueillette sauvage et cuisine", OrganizerId = 10, Location = "Pallet", Duration = 8, MaxParticipants = 12, MaxInvitesPerPerson = 1, Datetime = new DateTime(2024, 11, 16, 9, 0, 0), Description = "Partez à la découverte des plantes comestibles locales et apprenez à les cuisiner dans des recettes simples et savoureuses." };
            ...
            Activity a16 = new Activity() { Name = "Cuisiner avec des plantes sauvages", OrganizerId = 1, Location = "Vallet", Duration = 1, MaxParticipants = 10, MaxInvitesPerPerson = 1, Datetime = new DateTime(2024, 11, 10, 14, 0, 0), Description = "Apprenez à identifier et cuisiner les plantes sauvages de votre région pour enrichir votre cuisine avec des produits naturels et locaux." };
            ...
            Activity a18 = new Activity() { Name = "Atelier fabrication de sirops et infusions", OrganizerId = 4, Location = "Gétigné", Duration = 4, MaxParticipants = 12, MaxInvitesPerPerson = 1, Datetime = new DateTime(2024, 11, 27, 15, 0, 0), Description = "Apprenez à préparer vos propres sirops et infusions à partir de plantes locales pour des boissons saines et savoureuses." };
