...
namespace AgriNov.Models
{
    public class ServiceBoxContract : IServiceBoxContract
    {
        ...
        public void InitializeTable()
        {
            ...
            BoxContract bc16 = new BoxContract() { ProductType = ProductType.VEGETABLES, Seasons = Seasons.WINTER, Years = Years._2024, Price = 8M, MaxSubscriptions = 5, ForSale = true, ImgSmallBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "vegetablessmall.jpg")), ImgBigBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "vegetablesbig.jpg")) };
            BoxContract bc17 = new BoxContract() { ProductType = ProductType.FRUITS, Seasons = Seasons.WINTER, Years = Years._2024, Price = 5M, MaxSubscriptions = 8, ForSale = true, ImgSmallBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "fruitsmall.jpg")), ImgBigBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "fruitbig.jpg")) };
            BoxContract bc18 = new BoxContract() { ProductType = ProductType.MEAT, Seasons = Seasons.WINTER, Years = Years._2024, Price = 16M, MaxSubscriptions = 8, ForSale = true, ImgSmallBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "meatsmall.jpg")), ImgBigBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "meatbig.jpg")) };
            ...
            BoxContract bc20 = new BoxContract() { ProductType = ProductType.EGGS, Seasons = Seasons.WINTER, Years = Years._2024, Price = 2M, MaxSubscriptions = 9, ForSale = true, ImgSmallBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "eggssmall.jpg")), ImgBigBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "eggsbig.jpg")) };
            ...
            BoxContract bc22 = new BoxContract() { ProductType = ProductType.MEAT, Seasons = Seasons.SPRING, Years = Years._2025, Price = 6M, MaxSubscriptions = 6, ForSale = false, ImgSmallBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "meatsmall.jpg")), ImgBigBoxContract = File.ReadAllBytes(Path.Combine(dirPath, "meatbig.jpg")) };
